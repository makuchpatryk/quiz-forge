import { v as vueExports, s as serverRenderer_cjs_prodExports, u as useRouter, a as useNuxtApp, r as resolveRouteObject, b as useRuntimeConfig, n as navigateTo, c as nuxtLinkDefaults } from './server.mjs';
import { v as parseQuery, h as hasProtocol, f as joinURL, A as withTrailingSlash, B as withoutTrailingSlash } from '../nitro/nitro.mjs';
import { _ as _export_sfc, u as useHead } from './_plugin-vue_export-helper-C41st9OO.mjs';
import 'node:http';
import 'node:https';
import 'node:zlib';
import 'node:stream';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${serverRenderer_cjs_prodExports.ssrRenderAttrs(vueExports.mergeProps({ class: "antialiased bg-white dark:bg-black dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-black" }, _attrs))} data-v-fd9daea4><div class="fixed left-0 right-0 spotlight z-10" data-v-fd9daea4></div><div class="max-w-520px text-center z-20" data-v-fd9daea4><h1 class="font-medium mb-8 sm:text-10xl text-8xl" data-v-fd9daea4>${serverRenderer_cjs_prodExports.ssrInterpolate(__props.statusCode)}</h1><p class="font-light leading-tight mb-16 px-8 sm:px-0 sm:text-4xl text-xl" data-v-fd9daea4>${serverRenderer_cjs_prodExports.ssrInterpolate(__props.description)}</p><div class="flex items-center justify-center w-full" data-v-fd9daea4>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/nuxt@3.19.2_@parcel+watcher@2.5.1_@types+node@20.19.17_@vue+compiler-sfc@3.5.22_db0@0.3.2_esl_ukqhsfz7ar3yzw23oeaguszyza/node_modules/nuxt/dist/app/components/error-404.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const error404 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-fd9daea4"]]);

export { error404 as default };
//# sourceMappingURL=error-404-DmUWRXA4.mjs.map
