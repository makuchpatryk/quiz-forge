...
var response_add_event_1 = require("../events/response-add.event");
var ResponseController = /** @class */ (function () {
    function ResponseController(eventEmitter) {
        this.eventEmitter = eventEmitter;
    }
    ResponseController.prototype.handleQuestionResponse = function () {
        return __awaiter(this, void 0, void 0, function () {
            var payload;
            return __generator(this, function (_a) {
                // insert data into the response table
                console.log('This is inside the controller');
                payload = new response_add_event_1.ResponseAddEvent();
                payload.userId = 1;
                payload.optionId = 33;
                this.eventEmitter.emit(event_constants_1.events.RESPONSE_SUBMITTED, payload);
                return [2 /*return*/, { message: 'Response taken' }];
            });
        });
    };
    __decorate([
        (0, common_1.Post)('')
    ], ResponseController.prototype, "handleQuestionResponse");
